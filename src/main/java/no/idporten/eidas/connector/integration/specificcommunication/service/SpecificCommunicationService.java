...
public interface SpecificCommunicationService {
     ...
     * @throws SpecificConnectorException if the {@link BinaryLightToken} could not be created.
     */
    BinaryLightToken putRequest(final ILightRequest iLightRequest) throws SpecificConnectorException;
     ...
     * @throws SpecificConnectorException if the id could not be obtained
     */
    ILightRequest getAndRemoveRequest(String tokenBase64, Collection<AttributeDefinition<?>> registry) throws SpecificConnectorException;
     ...
     * @throws SpecificConnectorException if the {@link BinaryLightToken} could not be created.
     */
    BinaryLightToken putResponse(ILightResponse iLightResponse) throws SpecificConnectorException;
     ...
     * @throws SpecificConnectorException if the id could not be obtained
     */
    ILightResponse getAndRemoveResponse(String tokenBase64, Collection<AttributeDefinition<?>> registry) throws SpecificConnectorException;
}
