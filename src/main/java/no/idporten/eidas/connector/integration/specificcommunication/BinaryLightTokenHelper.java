...
public class BinaryLightTokenHelper {
     ...
     * @throws SpecificConnectorException if the {@code algorithm} is an invalid one
     */
    public static String getBinaryLightTokenId(final @Nonnull String binaryLightTokenBase64, final String secret, final String algorithm) throws SpecificConnectorException {
        ...
        try {
            ...
            throw new SpecificConnectorException(ErrorCodes.INTERNAL_ERROR.getValue(), e);
        }
     ...
     * @throws SpecificConnectorException when digest algorithm could not be found.
     */
    public static BinaryLightToken createBinaryLightToken(String issuerName, String secret, String algorithm) throws SpecificConnectorException {
